...
extension Module {
  ...
  /// Creates a reference to `functionID`, which is in `module`, without specialization.
  ///
  ...
  /// Creates a reference to `functionID`, which is in `module`, specialized by `specialization` in
  /// `scopeOfUse`.
  ///
  /// - Requires: `specialization` supplies arguments for all generic parameters of `f`.
  func makeReference(
  ...
  /// Creates a reference to the lowered form of `declID` in `module`, specialized by `specialization`
  /// in `scopeOfUse`.
  ///
